...
var presenterWindow = 'undefined';


function openPresenterWindow() {
  presenterWindow = window.open(document.location, 'presenterWindow');
  presenterWindow.curSlide = curSlide;

  // Fjern lenken vi trykket på
  orginalLink = document.getElementById('presenterLink');
  if(orginalLink !== 'undefined') {
    orginalLink.parentNode.removeChild(orginalLink);  
  }
}
...
function updateSlides() {
  ...
  if(presenterWindow !== 'undefined' && presenterWindow.curSlide !== 'undefined' && curSlide !== 'undefined') {
      presenterWindow.curSlide = curSlide;
      presenterWindow.updateSlides(); 
  }
